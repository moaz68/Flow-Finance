...
file_put_contents($file2,json_encode(array_values($filt2),JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE));
file_put_contents($file3,json_encode(array_values($filt3),JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE));
file_put_contents($file4,json_encode(array_values($filt4),JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE));
