...
function sendOTP($userEmail, $otp) {
    ...
    curl_setopt($ch, CURLOPT_FOLLOWLOCATION, true); // مهم جداً عشان تحويلات جوجل
    ...
    // التحقق إذا كان الرد من جوجل هو "Success"
    return (trim($response) === "Success");
}

// دالة وسيطة عشان متضطرش تغير اسم الدالة في كل ملفات الـ API التانية
